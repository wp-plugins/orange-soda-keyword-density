    ...
    return this.find("span.orangeSoda_highlight").each(function () {
        ...
        jQuery(document).ready(function() {
            ...
            function orangeSoda_click(e) 
            {
              ...
              var message2 = "<table class='orangesoda_word_table' style='border:none; border-style:none; width:100%'><tbody><tr><th>Count</th><th>Density</th><th>Word</th></tr><tr><td>"+searchNumber+"</td><td>"+parseFloat((searchNumber/wordCount)*100).toFixed(1)+"%</td><td>"+searchPhrase+"</td></tbody></table>";
